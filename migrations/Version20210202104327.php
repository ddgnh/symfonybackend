 ...
 */
final class Version20210202104327 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE kantor (id UUID NOT NULL, jenis_kantor_id UUID NOT NULL, parent_id_id UUID DEFAULT NULL, nama VARCHAR(255) NOT NULL, level INT DEFAULT NULL, tanggal_aktif TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, tanggal_nonaktif TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, sk VARCHAR(255) DEFAULT NULL, alamat TEXT DEFAULT NULL, telp VARCHAR(255) DEFAULT NULL, fax VARCHAR(255) DEFAULT NULL, zona_waktu VARCHAR(4) DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, legacy_kode VARCHAR(10) DEFAULT NULL, legacy_kode_kpp VARCHAR(3) DEFAULT NULL, legacy_kode_kanwil VARCHAR(3) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_A3CC27035EB4E08C ON kantor (jenis_kantor_id)');
        $this->addSql('CREATE INDEX IDX_A3CC2703B3750AF4 ON kantor (parent_id_id)');
        ...
        $this->addSql('CREATE INDEX idx_kantor_relation ON kantor (id, jenis_kantor_id, parent_id_id, level)');
        ...
        $this->addSql('COMMENT ON COLUMN kantor.parent_id_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE pegawai (id UUID NOT NULL, user_id UUID NOT NULL, jenis_kelamin_id UUID NOT NULL, agama_id UUID NOT NULL, nama VARCHAR(255) NOT NULL, tanggal_lahir TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, tempat_lahir VARCHAR(255) NOT NULL, pensiun BOOLEAN NOT NULL, npwp VARCHAR(255) DEFAULT NULL, nik VARCHAR(16) DEFAULT NULL, nip9 VARCHAR(9) DEFAULT NULL, nip18 VARCHAR(18) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_98835748A76ED395 ON pegawai (user_id)');
        $this->addSql('CREATE INDEX IDX_98835748D185AB0C ON pegawai (jenis_kelamin_id)');
        $this->addSql('CREATE INDEX IDX_988357488FE2EE60 ON pegawai (agama_id)');
        ...
        $this->addSql('CREATE INDEX idx_pegawai_relation ON pegawai (id, user_id, jenis_kelamin_id, agama_id)');
        $this->addSql('COMMENT ON COLUMN pegawai.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN pegawai.user_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN pegawai.jenis_kelamin_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN pegawai.agama_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE unit (id UUID NOT NULL, jenis_kantor_id UUID NOT NULL, eselon_id UUID NOT NULL, nama VARCHAR(255) NOT NULL, level INT NOT NULL, tanggal_aktif TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, tanggal_nonaktif TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, legacy_kode VARCHAR(10) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX idx_unit_legacy ON unit (id, legacy_kode)');
        $this->addSql('CREATE INDEX idx_unit_relation ON unit (id, jenis_kantor_id, eselon_id)');
        ...
        $this->addSql('ALTER TABLE kantor ADD CONSTRAINT FK_A3CC2703B3750AF4 FOREIGN KEY (parent_id_id) REFERENCES kantor (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE pegawai ADD CONSTRAINT FK_98835748D185AB0C FOREIGN KEY (jenis_kelamin_id) REFERENCES jenis_kelamin (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE pegawai ADD CONSTRAINT FK_988357488FE2EE60 FOREIGN KEY (agama_id) REFERENCES agama (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pegawai DROP CONSTRAINT FK_988357488FE2EE60');
        ...
        $this->addSql('ALTER TABLE pegawai DROP CONSTRAINT FK_98835748D185AB0C');
        $this->addSql('ALTER TABLE jabatan_pegawai DROP CONSTRAINT FK_53FE676A2C104734');
        $this->addSql('ALTER TABLE kantor DROP CONSTRAINT FK_A3CC2703B3750AF4');
